...
\begin{itemize}
    ...
    \item \textbf{Highest Rated Features:} When asked which features were most useful, the student body overwhelmingly praised the \textbf{Patient Medical Dashboard}, the \textbf{Medical Certificate Issuance}, and the automated \textbf{BMI Calculation} tools. Students noted that obtaining a medical certificate without waiting in physical queues was a massive operational improvement.
