...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{ConceptualFramewor}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{SystemArchitecture}}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\textwidth]{ContextDiagram}
...
\begin{itemize}
    ...
    \item \textbf{Doctor and Dentist:} Both roles are endowed with full clinical and administrative access, allowing them to diagnose, prescribe treatments, and access all feedback analytics. For the \textbf{Dentist} role, irrelevant medical fields are dynamically disabled to streamline the dental workflow, and a dedicated \textbf{Visual Teeth Chart} is included for precise oral geography mapping. Both roles, along with the Nurse role, have the authority to generate comprehensive clinical reports featuring charts, graphs, dynamic filtering capabilities, and fixed formatting. Furthermore, medical-related reports are tailored to show all relevant clinical information.
    \item \textbf{Nurse:} Functions in a supervisory and clinical data-entry capacity. Nurses are authorized to manage patient intake, record vital signs, input treatment plans, and generate medical-related reports tailored to show all relevant clinical information. They can also draft medical certificates (which remain pending until Doctor issuance).
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{AuthenticationWorkflow}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{ClinicalRecordSecurityPipeline}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{MedicalCertificatePipeline}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{WebsiteHomeDashboard}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{StudentFacingPatientMedicalDashboard}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{StaffSidePatientList}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{StudentSideCampaignsFeed}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{Medical Certificate Generation Preview}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{ERD_Final}}
