...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.35\linewidth]{ConceptualFramewor}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.35\linewidth]{SystemArchitecture}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.4\linewidth]{ERD_Final}
