...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.25\textwidth]{ConceptualFramewor}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.3\textwidth]{SystemArchitecture}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{ContextDiagram}}
...
\begin{itemize}
    ...
    \item \textbf{Doctor and Dentist:} Both roles are endowed with full clinical and administrative access, allowing them to diagnose, prescribe treatments, and access all feedback analytics. For the \textbf{Dentist} role, irrelevant medical fields are dynamically disabled to streamline the dental workflow, and a dedicated \textbf{Visual Dental Record Interface} is included for precise oral geography mapping. Both roles, along with the Nurse role, have the authority to generate comprehensive clinical reports featuring charts, graphs, dynamic filtering capabilities, and fixed formatting. Furthermore, medical-related reports are tailored to show all relevant clinical information.
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.25\textwidth]{AuthenticationWorkflow}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.25\textwidth]{ClinicalRecordSecurityPipeline}}
...
\begin{figure}[!ht]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.25\textwidth]{MedicalCertificatePipeline}}
