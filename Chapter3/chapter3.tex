...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.75\textwidth]{SystemArchitecture}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{ContextDiagram}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{AuthenticationWorkflow}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{ClinicalRecordSecurityPipeline}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{MedicalCertificatePipeline}
