...
\begin{itemize}
    \item \textbf{Dental Record Entry \& Streamlined Entry:} Dentists will be instructed on recording tooth conditions using the \textbf{FDI notation (11-48)} numerical range, strictly enforced via regex. To accelerate high-volume clinic days, Dentists will master the \textbf{"Consultation Only" mode}, which makes full diagnoses optional, and utilize the explicit "Referral To" field.
\end{itemize}

\section{Module 3: Administrative Output \& Reporting (For Staff \& Admins)}
...
\begin{itemize}
    ...
    \item \textbf{Reporting:} Clinical staff will practice generating \textbf{Visit Trends} and \textbf{Clinic Operational Density Reports} using the Celery-powered asynchronous reporting module. \textbf{Admins} will receive additional training on generating \textbf{System Audit Reports} for security and accountability monitoring.
\end{itemize}
